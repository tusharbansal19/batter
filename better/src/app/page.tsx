...
import { Play, Star, Phone, ChevronRight, ArrowRight } from 'lucide-react';
    ...
    <section className="bg-white py-20 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 mb-12">
          {/* AI Mortgage Lending */}
          <Link href="/about-us">
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-shadow cursor-pointer">
    ...
    <section className="bg-green-800 text-white py-16 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/start">
            <button className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-full text-lg font-semibold transition-colors flex items-center justify-center">
              Start Pre-approval
              <ArrowRight className="ml-2 w-5 h-5" />
            </button>
          </Link>
          <Link href="/mortgage-calculator">
            <button className="border-2 border-white text-white hover:bg-white hover:text-green-800 px-8 py-4 rounded-full text-lg font-semibold transition-colors">
              Calculate Payment
            </button>
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <Link href="/start" className="block text-gray-600 hover:text-gray-800">Buy a home</Link>
              <Link href="/start" className="block text-gray-600 hover:text-gray-800">Sell a home</Link>
              <Link href="/start" className="block text-gray-600 hover:text-gray-800">Get home inspection</Link>
            </div>
          </div>
